  ...
  return (
    <body className="container-screen h-screen ">
      ...
      <section id="products" className="h-auto  py-12 bg-gray-100">
        {/* product buttons */}
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl" style={{ color: 'rgb(239, 121, 152)' }} >Nossos produtos</h1>
        <div className="flex flex-wrap justify-center space-x-2 md:space-x-8 mt-4" style={{fontFamily: 'Montserrat'}}>
          <a href="" className="btn bg-transparent border rounded hover:bg-pink-400 hover:text-white py-2 px-2 md:px-4">Tudo</a>
          <a href="" className="btn bg-transparent border rounded hover:bg-pink-400 hover:text-white py-2 px-2 md:px-4">Bolos</a>
          <a href="" className="btn bg-transparent border rounded hover:bg-pink-400 hover:text-white py-2 px-2 md:px-4">Pães</a>
          <a href="" className="btn bg-transparent border rounded hover:bg-pink-400 hover:text-white py-2 px-2 md:px-4">Doces</a>
          <a href="" className="btn bg-transparent border rounded hover:bg-pink-400 hover:text-white  py-2 px-2 md:px-4">Assados</a>
        </div>
        {/* search bar */}
      ...
      <section className="flex justify-center items-center h-2/4 bg-gray-100" id="contact">
        <div className="space-y-12" >
          ...
          <div className="space-y-2 mx-5 md:mx-auto">
            <div className="flex flex-wrap  md:space-x-2 space-y-2 md:space-y-0 ">
              ...
              <div>
                <textarea type="text" placeholder="digite sua mensagem..." className="md:w-72 h-auto md:h-full bg-gray-100 border-2 border-gray-400 pl-2 pt-1" style={{resize:'none'}}/>
              </div>
            </div>
